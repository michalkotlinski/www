...
Держатели токенов DAO будет иметь возможность голосовать при принятии важных решений, относящихся к управлению DAO, включая полномочия перераспределять прибыли между собой.


### Что такое токены DAO?

Токены DAO позволяют держателям:
...
Нет. Токены предназначены только для того, чтобы представлять голос держателя пропорционально их количеству выданному ему как часть DAO. Если вы хотите заниматься майнингом, попробуйте [Ether](https://github.com/ethereum/go-ethereum/wiki/Mining).
...
Нет, мы хотим сделать все возможное для того, чтобы любой желающий смог принять участие в этой новой комьюнити обмена. Процесс покупки будет проходить полностью онлайн посредством простого веб-сайта. Если у вас уже есть Ether-кошелек, у вас будет возможность его использовать, или сайт сгенерирует вам новый.
