...
Наша цель - построить инфраструктуру для экономики совместного использования, которая позволила бы каждому покупать, продавать, арендовать все что угодно и без посредников. 

Slock.it упрощает процессы совместного использования вещей следующим образом:
...
- Страховыми компаниями, работающими в области экономики совместного использования
...
### Является ли проект Slock.it открытым?
...
Чтобы присоединиться, просто зарегистрируйтесь в нашем [чате в Slack](http://Slock.it:3000/).
...
Мы используем умные контракты, созданные на основе Ethereum Blockchain, поэтому люди по всему миру имеют возможность строить новое будущее для экономики совместного использования. И в качестве благодарности за их раннюю помощь, они будет вознаграждены в форме токенов DAO, которые имеют много выгод.
